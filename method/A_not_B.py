...
if len(question_data) < args.sample_size:
    raise ValueError("Insufficient data after filtering. Cannot find enough items where 'gt' != 'a'.")
...
logging.info(f"Drop in Success Rate: {(success_rate_standard - success_rate_a_not_b) / success_rate_standard}")
